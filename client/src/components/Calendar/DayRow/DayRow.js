...
import { isSameDay, format, startOfWeek, addDays, startOfMonth, endOfMonth, endOfWeek, isSameMonth } from "date-fns";

const generateRows = ({currentDate, selectedDate, onDateClick, dateClicked })=>{
...
const DayRow = ({currentDate, selectedDate, onDateClick, dateClicked}) => {
    const rows = generateRows({currentDate, selectedDate, onDateClick, dateClicked});
